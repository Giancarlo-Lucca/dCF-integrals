...
In the file statistical, you will find the results obtained by the Align Friedman Rank test. In a similar structure of the previous results, each sheet is related with a fuzzy measure. Per sheet, we provide the comparisons of the functions F against the difference. This file also consider D1 to D5 as being the RDFs and the Id. of the original function is related with the D0, that is, the RDF that is based on the classical difference.  
